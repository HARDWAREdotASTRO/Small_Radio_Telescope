 ...
 * Date: 4/20/2022
 * 
 * Purpose: Brings telescope to desired resting position
 * 
 * 
 */
...
void loop() {
  ...
  //convert the right ascension and declination into reed counts

  int azimuthal_count = right_ascension * ( k); 

  int latitudinal_count = declination * (k); 
